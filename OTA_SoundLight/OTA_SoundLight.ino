/******************************************************
 *SoundLight Controller – Option B (Initial Setup)
 *
 * FEATURES:
...
const char* AP_SSID = "DO-SoundLight";
...
void handleRoot() {
  ...
  html += F(
    ...
    "</style></head><body>"
    "<h1>SoundLight  Configuration</h1>"
...
void handleSave() {
  ...
  html += F(
    ...
    "<p>If this messagee does not clear, please restart the board.</p>"
    "</div></body></html>"
  );
